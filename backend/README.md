...
## Project Structure
    ...
    ├── testing_double_deploy_12  # Django project configurations
...
1. Clone this repo and `cd testing_double_deploy_12`
...
2. Clone this repo and `cd testing_double_deploy_12`
