"""
Django settings for testing_double_deploy_12 project.
...
ROOT_URLCONF = 'testing_double_deploy_12.urls'
...
WSGI_APPLICATION = 'testing_double_deploy_12.wsgi.application'
